...
public class SegmentedControlButton extends RadioButton {
    ...
    public void init(AttributeSet attrs, int defStyle) {
        if (attrs != null) {
            TypedArray a = this.getContext().obtainStyledAttributes(attrs, R.styleable.pitaya, defStyle, R.style.Widget_Holo_SegmentedControl);

            mTextAllCaps = a.getBoolean(R.styleable.pitaya_textAllCaps, false);
            setTextCompat(getText());

            int lineColor = a.getColor(R.styleable.pitaya_lineColor, 0);
            mLineHeightUnselected = a.getDimensionPixelSize(R.styleable.pitaya_lineHeightUnselected, 0);
            mLineHeightSelected = a.getDimensionPixelSize(R.styleable.pitaya_lineHeightSelected, 0);
